	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 CaP /home/sjarvis1/git/optogenetics/models/purkinje_miyasho/x86_64/CaP.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("CaP", "cannot be used with CVODE");}
