	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 K2 /home/sjarvis1/git/optogenetics/models/purkinje_miyasho/x86_64/K2.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("K2", "cannot be used with CVODE");}
