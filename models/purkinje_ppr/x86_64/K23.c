	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 K23 /home/sjarvis1/git/optogenetics/models/purkinje_ppr/x86_64/K23.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("K23", "cannot be used with CVODE");}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 55 in file K23.mod:\n:	gk = gkbar*m*z*z\n"); nrn_complain(_p); abort_run(error);}
