	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 2);
 	...
 	ivoc_help("help ?1 NaP /home/sjarvis1/git/optogenetics/models/purkinje_ppr/x86_64/NaP.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("NaP", "cannot be used with CVODE");}
