	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 CaE /home/sjarvis1/git/optogenetics/models/purkinje_ppr/x86_64/CaE.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("CaE", "cannot be used with CVODE");}
...
static _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
   ...
   _t_hexp = makevector(701*sizeof(double));
_first = 0;
}
