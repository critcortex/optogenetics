...
extern int nrn_get_mechtype();
 ...
 "setdata_NaPcvode", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define enacvode enacvode_NaPcvode
 double enacvode = 45;
#define mon mon_NaPcvode
 double mon = 1;
 ...
 "enacvode_NaPcvode", "mV",
 "gnabar_NaPcvode", "mho/cm2",
 0,0
};
 ...
 "enacvode_NaPcvode", &enacvode_NaPcvode,
 "mon_NaPcvode", &mon_NaPcvode,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 NaPcvode /home/sjarvis1/git/optogenetics/models/purkinje_ppr/x86_64/NaPcvode.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   ...
   alpha = 200.0 / ( 1.0 + exp ( ( v - 18.0 ) / ( - 16.0 ) ) ) ;
   beta = 25.0 / ( 1.0 + exp ( ( v + 58.0 ) / 8.0 ) ) ;
   sum = alpha + beta ;
   minf = alpha / sum ;
   tau = 1.0 / ( q10 * sum ) ;
   Dm = mon * ( minf - m ) / tau ;
