...
#define Alpha Alpha_nmdanet
 double Alpha = 0.35;
#define Beta Beta_nmdanet
 double Beta = 0.035;
...
#define usetable usetable_nmdanet
 ...
 "Alpha_nmdanet", &Alpha_nmdanet,
 "Beta_nmdanet", &Beta_nmdanet,
...
#define _tqitem &(_ppvar[2]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 nmdanet /home/sjarvis1/git/optogenetics/models/gaspirini/x86_64/nmdanet.mod\n");
