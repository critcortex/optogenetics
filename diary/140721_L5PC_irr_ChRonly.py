...
expbase = '140721_L5PC_irr_ChRonly'
...
def analyse_factors_invivo():
    ...
    for irr in irrs:
        ...
        #af.submenu_plot(0, self.expbase+'FI_gain_irr%.2f_tree%s_varyFactor_exp%s%s_'%(0.05,tree,exp[0],exp[1]))
        af.submenu_plot(5, expbase+'FI_gain_varyFactor_invivo_irr%g'%irr)
        af.submenu_plot(0, expbase+'FI_gain_varyFactor_invivo_irr%g'%irr)
        af.submenu_plot(10, expbase+'FI_gain_varyFactor_invivo_irr%g'%irr)
        """
