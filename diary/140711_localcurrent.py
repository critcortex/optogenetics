...
class Experiment_140711:
    ...
    def __init__(self,whole,stimulus):
        ...
        self.expbase = '140711_localcurrent_abstract'
        ...
        self.collection_same_total = [(1,2,7)]
    ...
    def get_current_locations_entire_tree(self,nbase,nsplit,nlevels,nseg=10):
        """
        ...
        command = "select_section_posn_bydistance"
...
if __name__ == '__main__':
    if len(sys.argv) <= 1:
        ...
        Experiment_140711(wholecell,inputtype).run_collection_spiketrain_soma()
    elif sys.argv[1] == 'analyse':
        wholecell,inputtype = sys.argv[2],sys.argv[3]
        Experiment_140711(wholecell,inputtype).analyse_this(inputtype)
    elif sys.argv[1] == 'gain':
        wholecell,inputtype = sys.argv[2],sys.argv[3]
        Experiment_140711(wholecell,inputtype).plot_gain()
    elif sys.argv[1] == 'bg':
        wholecell,inputtype = sys.argv[2],sys.argv[3]
        Experiment_140711(wholecell,inputtype).analyse_gain_background(inputtype)        
    else:
        wholecell,inputtype = sys.argv[2],sys.argv[3]
        print wholecell, inputtype
        #try:
        getattr(Experiment_140711(wholecell,inputtype),'run_collection_%s'%sys.argv[1])()
        #except:
