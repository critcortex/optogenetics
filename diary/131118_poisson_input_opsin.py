...
expbase = '131118_poisson_input_opsin'
                ...
                for extraloc in nstims:
                    for irr in irrs:
                        for factor in factors:
                            ...
                            chrdict =  {'exp':5e-4, 'irradiance' :irr, 'pulsewidth': 1000,'lightdelay':light_on,'interpulse_interval':250,  'n_pulses':1}
                            hrdict =  {'exp':5e-4, 'irradiance' :factor*irr, 'pulsewidth': 1000,'lightdelay':light_on,'interpulse_interval':250,  'n_pulses':1}
